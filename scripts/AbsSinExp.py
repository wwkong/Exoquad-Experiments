...
def write_plot(a, fBaseIntegral, dname):
    localPolyGrid = Tasmanian.makeLocalPolynomialGrid(1, 1, 13)
    ...
    ExoquadUtils.plotAccuracy(sTitle, 25, 1e-14, 1, fBaseIntegral, pIntegrandFn, pWeightFn, 1.0, sFname=sFname,
                              iLocalPolynomial=True, oEmptyRefGrid=localPolyGrid)
